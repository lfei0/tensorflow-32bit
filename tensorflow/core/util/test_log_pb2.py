...
_BUILDCONFIGURATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='config', full_name='tensorflow.BuildConfiguration.config', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='copts', full_name='tensorflow.BuildConfiguration.copts', index=2,
...
_MACHINECONFIGURATION = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='platform_info', full_name='tensorflow.MachineConfiguration.platform_info', index=1,
      number=2, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='cpu_info', full_name='tensorflow.MachineConfiguration.cpu_info', index=2,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='device_info', full_name='tensorflow.MachineConfiguration.device_info', index=3,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='available_device_info', full_name='tensorflow.MachineConfiguration.available_device_info', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='memory_info', full_name='tensorflow.MachineConfiguration.memory_info', index=5,
