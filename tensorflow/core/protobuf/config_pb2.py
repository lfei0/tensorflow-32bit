...
_RUNOPTIONS_TRACELEVEL = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FULL_TRACE', index=1, number=1,
      options=None,
      type=None),
  ],
  containing_type=None,
...
_CONFIGPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='operation_timeout_in_ms', full_name='tensorflow.ConfigProto.operation_timeout_in_ms', index=10,
...
_RUNOUTPUTS = _descriptor.Descriptor(
  name='RunOutputs',
  full_name='tensorflow.RunOutputs',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='step_stats', full_name='tensorflow.RunOutputs.step_stats', index=0,
...
_RUNOUTPUTS.fields_by_name['step_stats'].message_type = tensorflow_dot_core_dot_framework_dot_step__stats__pb2._STEPSTATS
...
DESCRIPTOR.message_types_by_name['RunOutputs'] = _RUNOUTPUTS
...
RunOutputs = _reflection.GeneratedProtocolMessageType('RunOutputs', (_message.Message,), dict(
