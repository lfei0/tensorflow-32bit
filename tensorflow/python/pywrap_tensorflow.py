...
class ServerInterface(_object):
    ...
    __del__ = lambda self : None;
    def Start(self): return _pywrap_tensorflow.ServerInterface_Start(self)
    def Stop(self): return _pywrap_tensorflow.ServerInterface_Stop(self)
    def Join(self): return _pywrap_tensorflow.ServerInterface_Join(self)
...
def NewServer(*args):
  return _pywrap_tensorflow.NewServer(*args)
...
def DeviceFactory_AddDevices(*args):
  return _pywrap_tensorflow.DeviceFactory_AddDevices(*args)
