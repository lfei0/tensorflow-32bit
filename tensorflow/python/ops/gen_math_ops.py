...
def add_n(inputs, name=None):
  ...
  Args:
    inputs: A list of at least 1 `Tensor` objects of the same type in: `float32`, `float64`, `int64`, `int32`, `uint8`, `uint16`, `int16`, `int8`, `complex64`, `qint8`, `quint8`, `qint32`.
...
def cross(a, b, name=None):
  ...
  Args:
    a: A `Tensor`. Must be one of the following types: `float32`, `float64`, `int32`, `int64`, `uint8`, `int16`, `int8`, `uint16`.
  ...
  """
  return _op_def_lib.apply_op("Cross", a=a, b=b, name=name)


def _digamma(x, name=None):
  ...
  Returns:
    A `Tensor`. Has the same type as `x`.
  """
  return _op_def_lib.apply_op("Digamma", x=x, name=name)
...
def equal(x, y, name=None):
  ...
  Args:
    x: A `Tensor`. Must be one of the following types: `float32`, `float64`, `uint8`, `int8`, `int16`, `int32`, `int64`, `complex64`, `quint8`, `qint8`, `qint32`, `string`.
    y: A `Tensor`. Must have the same type as `x`.
    name: A name for the operation (optional).
...
def _erf(x, name=None):
  ...
  Returns:
    A `Tensor`. Has the same type as `x`.
  """
  return _op_def_lib.apply_op("Erf", x=x, name=name)


def _erfc(x, name=None):
  ...
  Returns:
    A `Tensor`. Has the same type as `x`.
  """
  return _op_def_lib.apply_op("Erfc", x=x, name=name)
...
def fft2d(in_, name=None):
  ...
  """
  return _op_def_lib.apply_op("FFT2D", in_=in_, name=name)
...
def ifft2d(in_, name=None):
  ...
  """
  return _op_def_lib.apply_op("IFFT2D", in_=in_, name=name)
...
def _lgamma(x, name=None):
  ...
  Returns:
    A `Tensor`. Has the same type as `x`.
  """
  return _op_def_lib.apply_op("Lgamma", x=x, name=name)
...
def segment_max(data, segment_ids, name=None):
  ...
  Args:
    data: A `Tensor`. Must be one of the following types: `float32`, `float64`, `int32`, `int64`, `uint8`, `int16`, `int8`, `uint16`.
...
def sparse_segment_sqrt_n(data, indices, segment_ids, name=None):
  ...
  Returns:
    ...
    has size `k`, the number of segments.
  """
  return _op_def_lib.apply_op("SparseSegmentSqrtN", data=data,
                              indices=indices, segment_ids=segment_ids,
                              name=name)
...
def sparse_segment_sqrt_n_grad(grad, indices, segment_ids, output_dim0,
  ...
  Returns:
    A `Tensor`. Has the same type as `grad`.
  """
  return _op_def_lib.apply_op("SparseSegmentSqrtNGrad", grad=grad,
                              indices=indices, segment_ids=segment_ids,
                              output_dim0=output_dim0, name=name)
...
def squared_difference(x, y, name=None):
  ...
  Returns:
    A `Tensor`. Has the same type as `x`.
  """
  return _op_def_lib.apply_op("SquaredDifference", x=x, y=y, name=name)
