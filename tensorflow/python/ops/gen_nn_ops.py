...
def _bias_add(value, bias, data_format=None, name=None):
  ...
  """
  return _op_def_lib.apply_op("BiasAdd", value=value, bias=bias,
                              data_format=data_format, name=name)
...
def bias_add_grad(out_backprop, data_format=None, name=None):
  ...
  Args:
    out_backprop: A `Tensor`. Must be one of the following types: `float32`, `float64`, `int64`, `int32`, `uint8`, `uint16`, `int16`, `int8`, `complex64`, `qint8`, `quint8`, `qint32`.
      Any number of dimensions.
    data_format: An optional `string` from: `"NHWC", "NCHW"`. Defaults to `"NHWC"`.
      Specify the data format of the input and output data. With the
      default format "NHWC", the bias tensor will be added to the last dimension
  ...
  """
  return _op_def_lib.apply_op("BiasAddGrad", out_backprop=out_backprop,
                              data_format=data_format, name=name)
...
def _bias_add_v1(value, bias, name=None):
  ...
  Returns:
    ...
    Broadcasted sum of `value` and `bias`.
  """
  return _op_def_lib.apply_op("BiasAddV1", value=value, bias=bias, name=name)
...
def depthwise_conv2d_native(input, filter, strides, padding, name=None):
  ...
  Returns:
    A `Tensor`. Has the same type as `input`.
  """
  return _op_def_lib.apply_op("DepthwiseConv2dNative", input=input,
                              filter=filter, strides=strides, padding=padding,
                              name=name)
...
def depthwise_conv2d_native_backprop_filter(input, filter_sizes, out_backprop,
  ...
  Returns:
    ...
    the `filter` input of the convolution.
  """
  return _op_def_lib.apply_op("DepthwiseConv2dNativeBackpropFilter",
...
def depthwise_conv2d_native_backprop_input(input_sizes, filter, out_backprop,
  ...
  Returns:
    ...
    w.r.t. the input of the convolution.
  """
  return _op_def_lib.apply_op("DepthwiseConv2dNativeBackpropInput",
