...
class RunOptions : public ::google::protobuf::Message {
 public:
  ...
  static const TraceLevel NO_TRACE = RunOptions_TraceLevel_NO_TRACE;
  static const TraceLevel FULL_TRACE = RunOptions_TraceLevel_FULL_TRACE;
...
class RunOutputs : public ::google::protobuf::Message {
 public:
  RunOutputs();
  virtual ~RunOutputs();

  RunOutputs(const RunOutputs& from);

  inline RunOutputs& operator=(const RunOutputs& from) {
    CopyFrom(from);
    return *this;
  }

  static const ::google::protobuf::Descriptor* descriptor();
  static const RunOutputs& default_instance();

  void Swap(RunOutputs* other);

  // implements Message ----------------------------------------------

  inline RunOutputs* New() const { return New(NULL); }

  RunOutputs* New(::google::protobuf::Arena* arena) const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const RunOutputs& from);
  void MergeFrom(const RunOutputs& from);
  void Clear();
  bool IsInitialized() const;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const;
  void InternalSwap(RunOutputs* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
  ...
  // @@protoc_insertion_point(class_scope:tensorflow.RunOutputs)
 private:
  ...
  void InitAsDefaultInstance();
  static RunOutputs* default_instance_;
};
// ===================================================================
...
// optional .tensorflow.StepStats step_stats = 1;
inline bool RunOutputs::has_step_stats() const {
  return !_is_default_instance_ && step_stats_ != NULL;
}
inline void RunOutputs::clear_step_stats() {
  if (GetArenaNoVirtual() == NULL && step_stats_ != NULL) delete step_stats_;
  step_stats_ = NULL;
}
inline const ::tensorflow::StepStats& RunOutputs::step_stats() const {
  // @@protoc_insertion_point(field_get:tensorflow.RunOutputs.step_stats)
  return step_stats_ != NULL ? *step_stats_ : *default_instance_->step_stats_;
}
inline ::tensorflow::StepStats* RunOutputs::mutable_step_stats() {
  
  if (step_stats_ == NULL) {
    step_stats_ = new ::tensorflow::StepStats;
  }
  // @@protoc_insertion_point(field_mutable:tensorflow.RunOutputs.step_stats)
  return step_stats_;
}
inline ::tensorflow::StepStats* RunOutputs::release_step_stats() {
  
  ::tensorflow::StepStats* temp = step_stats_;
  step_stats_ = NULL;
  return temp;
}
inline void RunOutputs::set_allocated_step_stats(::tensorflow::StepStats* step_stats) {
  delete step_stats_;
  ...
  // @@protoc_insertion_point(field_set_allocated:tensorflow.RunOutputs.step_stats)
}
