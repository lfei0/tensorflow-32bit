...
class BuildConfiguration : public ::google::protobuf::Message {
 public:
  ...
  // repeated string copts = 3;
  int copts_size() const;
  void clear_copts();
  static const int kCoptsFieldNumber = 3;
  const ::std::string& copts(int index) const;
  ::std::string* mutable_copts(int index);
  void set_copts(int index, const ::std::string& value);
  void set_copts(int index, const char* value);
  void set_copts(int index, const char* value, size_t size);
  ::std::string* add_copts();
  void add_copts(const ::std::string& value);
  void add_copts(const char* value);
  void add_copts(const char* value, size_t size);
  const ::google::protobuf::RepeatedPtrField< ::std::string>& copts() const;
  ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_copts();
 ...
 private:
  ...
  ::google::protobuf::RepeatedPtrField< ::std::string> copts_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_tensorflow_2fcore_2futil_2ftest_5flog_2eproto();
  friend void protobuf_AssignDesc_tensorflow_2fcore_2futil_2ftest_5flog_2eproto();
  friend void protobuf_ShutdownFile_tensorflow_2fcore_2futil_2ftest_5flog_2eproto();
...
// repeated string config = 2;
inline int BuildConfiguration::config_size() const {
  return config_.size();
}
inline void BuildConfiguration::clear_config() {
  config_.Clear();
}
inline const ::std::string& BuildConfiguration::config(int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.BuildConfiguration.config)
  return config_.Get(index);
}
inline ::std::string* BuildConfiguration::mutable_config(int index) {
  // @@protoc_insertion_point(field_mutable:tensorflow.BuildConfiguration.config)
  return config_.Mutable(index);
}
inline void BuildConfiguration::set_config(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:tensorflow.BuildConfiguration.config)
  config_.Mutable(index)->assign(value);
}
inline void BuildConfiguration::set_config(int index, const char* value) {
  config_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:tensorflow.BuildConfiguration.config)
}
inline void BuildConfiguration::set_config(int index, const char* value, size_t size) {
  config_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:tensorflow.BuildConfiguration.config)
}
inline ::std::string* BuildConfiguration::add_config() {
  return config_.Add();
}
inline void BuildConfiguration::add_config(const ::std::string& value) {
  config_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:tensorflow.BuildConfiguration.config)
}
inline void BuildConfiguration::add_config(const char* value) {
  config_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:tensorflow.BuildConfiguration.config)
}
inline void BuildConfiguration::add_config(const char* value, size_t size) {
  config_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:tensorflow.BuildConfiguration.config)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
BuildConfiguration::config() const {
  // @@protoc_insertion_point(field_list:tensorflow.BuildConfiguration.config)
  return config_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
BuildConfiguration::mutable_config() {
  // @@protoc_insertion_point(field_mutable_list:tensorflow.BuildConfiguration.config)
  return &config_;
}

// repeated string copts = 3;
inline int BuildConfiguration::copts_size() const {
  return copts_.size();
}
inline void BuildConfiguration::clear_copts() {
  copts_.Clear();
}
inline const ::std::string& BuildConfiguration::copts(int index) const {
  // @@protoc_insertion_point(field_get:tensorflow.BuildConfiguration.copts)
  return copts_.Get(index);
}
inline ::std::string* BuildConfiguration::mutable_copts(int index) {
  // @@protoc_insertion_point(field_mutable:tensorflow.BuildConfiguration.copts)
  return copts_.Mutable(index);
}
inline void BuildConfiguration::set_copts(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:tensorflow.BuildConfiguration.copts)
  copts_.Mutable(index)->assign(value);
}
inline void BuildConfiguration::set_copts(int index, const char* value) {
  copts_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:tensorflow.BuildConfiguration.copts)
}
inline void BuildConfiguration::set_copts(int index, const char* value, size_t size) {
  copts_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:tensorflow.BuildConfiguration.copts)
}
inline ::std::string* BuildConfiguration::add_copts() {
  return copts_.Add();
}
inline void BuildConfiguration::add_copts(const ::std::string& value) {
  copts_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:tensorflow.BuildConfiguration.copts)
}
inline void BuildConfiguration::add_copts(const char* value) {
  copts_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:tensorflow.BuildConfiguration.copts)
}
inline void BuildConfiguration::add_copts(const char* value, size_t size) {
  copts_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:tensorflow.BuildConfiguration.copts)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
BuildConfiguration::copts() const {
  // @@protoc_insertion_point(field_list:tensorflow.BuildConfiguration.copts)
  return copts_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
BuildConfiguration::mutable_copts() {
  // @@protoc_insertion_point(field_mutable_list:tensorflow.BuildConfiguration.copts)
  return &copts_;
}
